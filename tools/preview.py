...
pub func main(arguments: list[str]) -> int!:
    ...
    let observed = editor.app.on_frame(func (elapsed: float) -> unit!:
        ...
        if frames == 4:
            ...
            editor.panels.adjust_sliders[9][0].set_value(70.0)
            editor.panels.adjust_sliders[9][1].set_value(70.0)
            editor.panels.adjust_sliders[9][2].set_value(-12.0)
            editor.panels.adjust_sliders[9][3].set_value(120.0)
